...
const footerNavigation = {
  products: [
    { name: "Vitamins and Minerals", href: "#" },
    { name: "Sports Nutrition", href: "#" },
    { name: "Weight Management", href: "#" },
    { name: "Herbs and Natural Remedies ", href: "#" },
    { name: "Beauty and Skin Care", href: "#" },
  ],
  customerService: [
    { name: "Contact", href: "#" },
    { name: "Shipping", href: "#" },
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
                ...
                <div className="mx-auto max-w-sm">
                  ...
                  <form className="mt-4 sm:mt-6 sm:flex">
                    ...
                    <div className="mt-3 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                      <button
                        type="submit"
                        className="flex w-full items-center justify-center rounded-md border border-transparent bg-brand-cta px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-brand-cta-hover focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-white"
                      >
                        Sign up
                      </button>
                    </div>
              ...
              <div className="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
                <div className="absolute inset-0 overflow-hidden rounded-lg">
                  ...
                  />
                  <div className="absolute inset-0 bg-brand-primary bg-opacity-90" />
                </div>
